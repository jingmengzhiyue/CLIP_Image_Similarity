...
def get_args_parser():
    ...
    parser.add_argument('--mode',default='predict', help='extract or predict,for extracting features or predicing similar images from corpus')
    return parser
...
if __name__ == '__main__':
    ...
    if args.mode == "extract":
        ...
        for image_file in tqdm.tqdm(test_images):
            ...
            # resnet50/152 model
                allVectors[image_filel] = extract_feature_single(args,model,image_file)
