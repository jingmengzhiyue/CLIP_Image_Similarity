...
parser.add_argument('--dataset_dir',default='/Users/alpha/Documents/public_datasets/dataset_fruit_veg/train',
help='path where to load images')
parser.add_argument('--test_image_dir',default='/Users/alpha/Documents/public_datasets/dataset_fruit_veg/val_images',
